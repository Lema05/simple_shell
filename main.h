...
/*
 * File: main.h
 * Auth: Collins Nasongo and Lema (Kipeno) Lemaiyan
 * Desc: Header file with all function declarations for
...
/**
 * struct built_in - handling builtins
 *
 * @command: pointer to char with command
 * @fun: function to excute
 */
